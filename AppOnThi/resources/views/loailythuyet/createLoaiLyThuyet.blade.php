...
<body>
   <form class="b" action="javascript:void(0)" method="POST" id="myform" enctype="multipart/form-data" onsubmit="addLoaiLyThuyet()">
   @csrf 
   <h2 class="a">THÊM LOẠI LÝ THUYẾT</h2>  
<a class="fas fa-home" href="/admin/listLoaiLyThuyet">Quay Lại</a></br></br>
   <div class="wrap_form">
       <label for="">Tên Loại Lý Thuyết</label>
       <input type="text" name="tenloaiLT">
   </div>
   <div class="wrap_form">
