...
<body>
    <form class="b" action="javascript:void(0)" method="POST" enctype="multipart/form-data" id="myform" onsubmit="addLoaiBienBao()">
    @csrf     
    <h2 class="a">THÊM LOẠI BIỂN BÁO</h2>
    <a class="fas fa-home" href="/admin/listLoaiBienBao">Quay Lại</a></br></br>
    <div class="warm_form">
            <label for="">Tên Loại Biển Báo</label>
            <input type="text" name="tenloaiBB">
        </div>
        <div class="warm_form">
